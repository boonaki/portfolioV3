...
const ExternalLinks = () => {
    return (
        <>
            ...
            <a href="https://www.linkedin.com/in/joshdurrett/" className="mx-2" title="Linkedin">
            ...
            <a href="https://github.com/boonaki" className="mx-2" title="Github">
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-github md:w-[38px] md:h-[38px] transition p-1 hover:bg-[#333] rounded-lg" width="34" height="34" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#FFFFFF" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
