         ...
         <div className="h-full max-w-[850px]">
            <div className="mb-4">
               <div>
                  ...
                  <div className="px-2">
                     <p className='mb-1'>A native desktop application written in Java with an adjustable, scrolling mouse macro to automate scrolling for a mobile game.</p>
                     <p className='mb-1'>My dad wanted a macro for a game he plays so he didn't have to risk hurting his wrist from the <a className='hover:text-blue-400' href='https://en.wikipedia.org/wiki/Repetitive_strain_injury'>repetitive motion</a>. This application automates the motion he did to remove the risk factor.</p>
               ...
               <div className="my-6 w-full">
                  ...
                  <div className="flex my-1 flex-wrap px-2">
                     <span className="mx-2 my-1 mx-2 my-1 p-1 hover:border-[#ebebeb] rounded-lg border-transparent border-2 transition"><span className='text-xs text-[#5ebdbd] font-semibold'># </span>Java</span>
                  </div>
               </div>
