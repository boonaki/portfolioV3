                    ...
                    <form>
                        <div className="md:flex my-2">
                            <div className="mx-2 md:mx-3 my-3">
                                ...
                                <input type="text" id="name" name="name" placeholder="Your Name" className="bg-transparent p-2 border-b-2 border-[#333] rounded-none placeholder-[#4c4c4c] w-full focus:outline-none focus:border-white transition"></input>
                            </div>
                            <div className="mx-2 md:mx-3 my-3">
                                <label for="email" className="sr-only">Email</label>
                                <input type="email" id="email" name="email" placeholder="Your Email" className="bg-transparent p-2 border-b-2 border-[#333] rounded-none placeholder-[#4c4c4c] w-full focus:outline-none focus:border-white transition"></input>
                            </div>
                        </div>
                        <div className="mx-3 my-2">
                            <label for="message" className="sr-only">Message</label>
                            <textarea className="bg-transparent p-2 border-b-2 border-[#333] rounded-none placeholder-[#4c4c4c] w-full focus:outline-none focus:border-white transition" rows="5" placeholder="Enter a Message" id="message" name="message"></textarea>
                        </div>
