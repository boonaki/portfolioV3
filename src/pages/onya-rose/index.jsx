            ...
            <div className="mb-4">
               ...
               <div className="my-6 w-full">
                  ...
                  <div className="flex my-1 flex-wrap px-2">
                     <span className="mx-2 my-1 mx-2 my-1 p-1 hover:border-[#ebebeb] rounded-lg border-transparent border-2 transition"><span className='text-xs text-[#d79046] font-semibold'># </span>HTML</span>
                     <span className="mx-2 my-1 mx-2 my-1 p-1 hover:border-[#ebebeb] rounded-lg border-transparent border-2 transition"><span className='text-xs text-[#d79046] font-semibold'># </span>CSS</span>
                     <span className="mx-2 my-1 mx-2 my-1 p-1 hover:border-[#ebebeb] rounded-lg border-transparent border-2 transition"><span className='text-xs text-[#d79046] font-semibold'># </span>Javascript</span>
                  </div>
               </div>
